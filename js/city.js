const selectCities = document.querySelectorAll(".select-city");

for (const select of selectCities) {
  console.log(select.querySelector("#form__state"));

  select.querySelector("#form__state").addEventListener("change", () => {
    irancitylist(
      select.querySelector("#form__state").value,
      select.querySelector("#form__city")
    );
  });
}

function irancitylist(state, element) {
  with (element) {
    options.length = 0;
